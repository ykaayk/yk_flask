/**
 * Created by K_God on 2017/6/16.
 */

// 七牛，头像上传。
$(function () {
    var domain = 'http://oqwrm9r74.bkt.clouddn.com/';
    // var progressBox = $('#avatar-img');
    // var progressBar = progressBox.children(0);
    // var uploadBtn = $('#upload-btn');
    // var submitBtn = $('#avatar-img');
    var uploader = Qiniu.uploader({
            runtimes: 'html5,flash,html4',      // 上传模式，依次退化
            browse_button: 'avatar-img',         // 上传选择的点选按钮，必需
            ...
            drop_element: 'avatar-img',          // 拖曳上传区域元素的ID，拖曳文件或文件夹后可触发上传
            ...
            init: {
                ...
                'FileUploaded': function(up, file, info) {
                    ...
                    var imgTag = $('#avatar-img').attr('src', fileUrl);
                },
    ...
    submitBtn.click(function (event) {
        ...
        xtajax.post({
            ...
            'success': function (data) {
                if(data['code'] == 200){
                    xtalert.alertSuccessToast('个人信息修改成功！');
